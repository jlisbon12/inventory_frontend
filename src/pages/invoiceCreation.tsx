...
const InvoiceCreation: FC = () => {
  ...
  const [invoiceItemQty, setInvoiceItemQty] =
    useState<invoiceCreationAddRemoveProps>({});
  const [invoiceItemDataQty, setInvoiceItemDataQty] =
    useState<invoiceCreationAddRemoveProps>({});
    ...
    <div className="invoice-creation">
      ...
      <div>
        ...
        <div>
          ...
          &nbsp;&nbsp;
          <Button danger onClick={clearInvoiceData}>
            Clear
          </Button>
        </div>
      </div>
